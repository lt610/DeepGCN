...
# title = 'Pubmed'
# method = 'DR1'
# train_accs0 = [81.63, 83.13, 81.16, 80.85, 80.48, 80.01, 79.69, 79.55, 79.44, 65.03, 63.4, 64.49, 64.78, 63.54, 63.26, 61.79]
# train_accs1 = [82.87, 81.72, 81.83, 81.52, 79.11, 79.02, 78.99, 79.21, 78.84, 78.48, 78.61, 78.54, 77.96, 78.4, 78.0, 77.1]
# test_accs0 = [80.38, 82.71, 80.48, 79.97, 79.92, 79.56, 79.06, 79.01, 79.21, 65.97, 62.73, 65.52, 64.66, 63.74, 64.15, 61.82]
# test_accs1 = [81.39, 80.43, 81.14, 80.93, 78.3, 78.4, 78.19, 78.35, 78.04, 77.59, 78.09, 78.04, 77.48, 77.84, 77.33, 76.77]
# draw(title, method, train_accs0, train_accs1, test_accs0, test_accs1)
...
# method = 'WE'
# train_accs0 = [81.63, 83.13, 81.16, 80.85, 80.48, 80.01, 79.69, 79.55, 79.44, 65.03, 63.4, 64.49, 64.78, 63.54, 63.26, 61.79]
# train_accs1 = [83.54, 82.76, 81.81, 80.86, 80.21, 80.01, 79.85, 79.3, 79.37, 65.02, 63.19, 64.28, 64.29, 63.95, 62.28, 62.41]
# test_accs0 = [80.38, 82.71, 80.48, 79.97, 79.92, 79.56, 79.06, 79.01, 79.21, 65.97, 62.73, 65.52, 64.66, 63.74, 64.15, 61.82]
# test_accs1 = [82.35, 82.71, 80.93, 80.32, 79.67, 79.92, 79.82, 78.8, 79.06, 65.16, 62.63, 65.37, 64.55, 64.55, 62.73, 62.63]
# draw(title, method, train_accs0, train_accs1, test_accs0, test_accs1)

# title = 'Pubmed'
# method = 'RE0'
# train_accs0 = [64.94, 90.81, 88.81, 87.84, 87.3, 87.09, 86.54, 86.24, 85.55, 85.61, 86.23, 85.63, 85.58, 85.03, 56.97, 48.12]
# train_accs1 = [82.65, 93.22, 93.86, 92.55, 93.31, 94.11, 93.6, 92.21, 91.4, 91.2, 91.04, 91.08, 90.93, 92.31, 92.0, 90.43]
# test_accs0 = [63.39, 86.76, 85.45, 85.45, 84.74, 84.74, 84.69, 84.53, 84.63, 84.84, 84.84, 84.13, 84.43, 83.67, 56.9, 47.77]
# test_accs1 = [81.34, 87.47, 87.27, 87.07, 87.98, 88.13, 88.69, 88.49, 87.63, 87.63, 88.03, 87.47, 86.11, 87.12, 87.53, 88.08]
# draw(title, method, train_accs0, train_accs1, test_accs0, test_accs1)

title = 'Pubmed'
method = 'SE'
train_accs0 = [81.63, 83.13, 81.16, 80.85, 80.48, 80.01, 79.69, 79.55, 79.44, 65.03, 63.4, 64.49, 64.78, 63.54, 63.26, 61.79]
train_accs1 = [82.52, 82.46, 83.34, 84.23, 83.61, 83.42, 82.41, 83.42, 83.45, 84.23, 84.24, 83.53, 83.48, 84.2, 83.47, 84.2]
test_accs0 = [80.38, 82.71, 80.48, 79.97, 79.92, 79.56, 79.06, 79.01, 79.21, 65.97, 62.73, 65.52, 64.66, 63.74, 64.15, 61.82]
