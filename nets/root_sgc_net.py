...
class RootSGCNet(nn.Module):
    def __init__(self, num_feats, num_classes, num_hidden, k=1, cached=False, bias=False, graph_norm=False,
                 pair_norm=False, dropedge=0, cutgraph=0):
        super(RootSGCNet, self).__init__()
        self.sgc = SGCLayer(num_feats, num_hidden, k, cached, bias, graph_norm, pair_norm, dropedge, cutgraph)
